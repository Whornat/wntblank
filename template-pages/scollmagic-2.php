<?php
/**
 Template Name: ScrollMagic exemple 2
 */
//get_header(); 
?><!DOCTYPE html>
...
<!--<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/scrollmagic/lib/jquery.min.js"></script>-->
	
	<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/scrollmagic/lib/greensock/TweenMax.min.js"></script>
  ...
  <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/scrollmagic/uncompressed/plugins/animation.gsap.js"></script>
	<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/scrollmagic/uncompressed/plugins/debug.addIndicators.js"></script>
</head>
<body>
	<ul id="menu"></ul>
