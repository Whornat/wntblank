<?php
/**
 Template Name: ScrollMagic exemple 3
 */
...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>#3 - A Simple Parallax Template using ScrollMagic and GreenSock</title>
        
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="apple-touch-icon" href="apple-touch-icon.png">
        
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/scrollmagic/demo3/css/styles.css">
        
        <script src="<?php echo get_template_directory_uri(); ?>/scrollmagic/demo3/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    ...
    <body>
        ...
        <div class="footer-container">
            <footer class="wrapper">
                <h3>2016 &copy; <a href="https://ihatetomatoes.net" target="_blank">Ihatetomatoes.net</a> | <a href="https://twitter.com/ihatetomatoes" target="_blank">@ihatetomatoes</a> | Images by <a href="http://raumrot.com/portfolio/set-06-free-for-commercial-use-photos/" target="_blank">Markus Spiske / raumrot.com</a> | Animate responsibly!</h3>
            </footer>
        </div>

		<script type='text/javascript' src='https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js?ver=4.6.1'></script>
        ...
        <script src="<?php echo get_template_directory_uri(); ?>/scrollmagic/demo3/main.js"></script>
    </body>
</html>